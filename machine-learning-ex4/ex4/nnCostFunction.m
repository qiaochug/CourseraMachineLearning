...
result_matrix1 = -y_matrix.*log(l3);

result_matrix2 = -(1-y_matrix).*log(1-l3);

Theta1_reg = Theta1(:, 2:end);
Theta1_sum = sum(sum(Theta1_reg.^2));

Theta2_reg = Theta2(:, 2:end);
Theta2_sum = sum(sum(Theta2_reg.^2));

J = (sum(sum(result_matrix1)) + sum(sum(result_matrix2)))/m +...
    lambda/(2*m)*(Theta1_sum + Theta2_sum);
